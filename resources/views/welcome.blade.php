        ...
        <div class="md:hidden">
          <button type="button"
            ...
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path class="hs-collapse-open:hidden" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"/>
              <path class="hs-collapse-open:block hidden" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
            </svg>
          </button>
        </div>
        ...
        <div class="max-w-5xl mx-auto px-4 xl:px-0 pt-24 lg:pt-32 pb-24">
            ...
            <div class="max-w-4xl">
                <p class="mt-5 text-white text-lg">
                    Notre plateforme offre une solution intégrée pour la gestion des procès-verbaux d'examens universitaires.
                    Simplifiez la documentation, le suivi et l'analyse de vos surveillances d'examens avec nos outils
        ...
        <div class="max-w-5xl mx-auto px-4 xl:px-0">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-neutral-800 p-6 rounded-lg">
                    ...
                    <p class="text-neutral-400">Créez et gérez facilement vos procès-verbaux d'examens en quelques clics.</p>
                </div>
                ...
                <div class="bg-neutral-800 p-6 rounded-lg">
                    ...
                    <p class="text-neutral-400">Surveillez l'avancement et générez des rapports détaillés instantanément.</p>
                </div>
                ...
                <div class="bg-neutral-800 p-6 rounded-lg">
                    ...
                    <p class="text-neutral-400">Protection des données et gestion sécurisée des accès utilisateurs.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-neutral-900" id="contact">
      <div class="max-w-5xl px-4 xl:px-0 py-16 lg:py-24 mx-auto">
        ...
        <div class="max-w-3xl mb-12">
          ...
          <p class="text-gray-200">Nous sommes là pour répondre à vos questions et vous accompagner dans la mise en place de notre solution.</p>
        </div>
        <!-- End Title -->
          ...
          <div class="bg-neutral-800/50 p-6 rounded-xl">
            <form>
              <div class="space-y-6">
                ...
                <!-- University Input -->
                <div>
                  <label for="university" class="block text-sm font-medium text-gray-200 mb-2">Université</label>
